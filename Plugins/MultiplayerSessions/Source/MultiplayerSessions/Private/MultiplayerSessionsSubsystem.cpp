...
void UMultiplayerSessionsSubsystem::FindSessions(int32 MaxSearchResults)
{
	...
	LastSessionSearch->bIsLanQuery = IOnlineSubsystem::Get()->GetSubsystemName() == "NULL" ? true : false; // Assuming "NULL" is the LAN subsystem
	LastSessionSearch->QuerySettings.Set(SEARCH_LOBBIES, true, EOnlineComparisonOp::Equals); // Only find sessions with presence enabled
...
bool UMultiplayerSessionsSubsystem::IsSessionInterfaceValid()
{
	if (!SessionInterface)
	{
